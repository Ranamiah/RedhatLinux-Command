...
অথবা
Project Manager
ভাবো তুমি একটি অফিসের ম্যানেজার।
সব কর্মচারীকে কাজ দিচ্ছে কে?
👉 Manager
ঠিক তেমনি Django-এর সব Command এই ফাইলের মাধ্যমে চলে।
এর কাজ
এটার মাধ্যমে তুমি
Server চালাও
Migration করো
...
সব Configure করতে হয়।

settings.py ঠিক সেই Configuration File।
...
Admin Panel-এ কোন Model দেখাবে
...
Admin Panel-এ Student দেখা যাবে।
...
যেখানে Data Save হয়।

১০. init.py

এটা Python-কে বলে

এই Folder একটা Package।
...
এটা Production Server-এর জন্য।

যখন Website Internet-এ Publish করবে
